...
var StringArray = React.createClass({
    ...
    var BuildGraph = React.createClass({
        componentDidMount: function() {
            var self = this;
            d3.json("/why-not-make/harvey.json", function(error, graph) {
                var targs = {};
                var links = [];
                var nodes = {};
                var edges = {};
                ...
                function addToGraph(g) {
                    for (var key in g.Edges) {
                        ...
                        targs[g.Edges[key].Target.Name].Built= g.Edges[key].Built;
                        var link  = {};
                        var p = key.split(":")
                        link.source = p[1];
                        link.target =p[0];
                ...
                function hashColor(d) {
                    ...
                    console.log(targs[d.name].Built);
                    if (targs[d.name].Built) {
                        return "#6cc644";
                    } else {
                        return "#bd2c00"
                    }
